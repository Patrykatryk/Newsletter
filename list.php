...
if(!isset($_SESSION['logged_id'])) {
    ...
    if (isset($_POST['login'])){
        ...
        $login = filter_input(INPUT_POST, 'login'); // filter_input pobiera 
        ...
        $userQuery -> bindValue(':login', $login , PDO::PARAM_STR); // dołącanie danych
        $userQuery -> execute();
        ...
        if ($user && password_verify($password, $user['password'])) {  // jesli suer istneije i hasló zgadza sięz hasłem zachaszowany w bazie 
